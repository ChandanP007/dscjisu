---
    name: Compose Camp Day 02 | Basic Layout
    ...
    locationUrl: https://gdsc.community.dev/events/details/developer-student-clubs-jis-university-kolkata-presents-compose-camp-day-02-basic-layout/
    date: 2022/09/17
    eventLink: https://gdsc.community.dev/events/details/developer-student-clubs-jis-university-kolkata-presents-compose-camp-day-02-basic-layout/
    isCompleted: true
    isActive: false
    type: Compose Camp
    locationName: Online
